function init() {
  ...
  // Let som håller reda på vilken sida anv befinner sig på
  let current = 0;
  let scrollSlide = 0;
  ...
  // gör klickad punkt vit och tar bort vit om den inte är active
  ...
  function nextSlide(pageNumber) {
    ...
    // prevents clicking on dots until animation is finished
